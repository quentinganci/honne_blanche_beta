...
if (isset($_POST["submit"])) {
    ...
    $from = 'Hedone Blanche Service apres vente ';
        ...
        <div class="row">
            <div class="col-6">
                <div class="lef_section_contact">
                    <div class="container">
                        <div class="row">
                            <div class="barre"></div>
                            <h1>Service après-vente</h1>

                        </div>
                        <div class="row">
                            <h3>CONTACT</h3>
                        </div>
                        <form role="form" method="post" action="service_apres_vente_contact.php">
            ...
            <div class="col-6">
                <div class="right_section_contact">
                    <h1>Créateur de valeur,<br> artisan de talent</h1>
                    <p>Vous avez une interrogation ou une remarque concernant votre dernier achat. Veuillez remplir le formulaire et nous reviendrons vers vous dans les plus brefs délais.<br><br>
                        Si vous avez des questions relatives à l’entretien du sac, rendez-vous en bas du site dans la partie « précautions ».</p>
                </div>
            </div>
        </div>
    </div>
