        ...
        <div class="row">
            <div class="col-6">
                <div class="lef_section_contact">
                    <div class="container">
                        ...
                        <form role="form" method="post" action="presse_contact.php">
            ...
            <div class="col-6">
                <div class="right_section_contact">
                    <h1>Il faut avec les mots de tout le monde <br> écrire comme personne</h1>
                    <p>Pour toute demande d’autorisation de publication, veuillez nous faire part de votre demande.</p>
                </div>
            </div>
        </div>
    </div>
