...
if (isset($_POST["submit"])) {
    ...
    $from = 'Hedone Blanche Collaborations ';
...
<html>
  <head>
    ...
    <title>Contact collaborations</title>
        ...
        <div class="row">
            <div class="col-6">
                <div class="lef_section_contact">
                    <div class="container">
                        ...
                        <form role="form" method="post" action="collaborations_contact.php">
            ...
            <div class="col-6">
                <div class="right_section_contact">
                    <h1>Aucun de nous ne sait ce que <br>nous savons tous, ensemble</h1>
                    <p>Artiste, photographe, Designer, Architecte, Danseur... Vous avez une idée et vous voulez la concrétiser en collaborant avec nous. Qu’il s’agisse d’événement artistique, d’une création de produit, ou d’une autre collaboration, nous sommes ouverts à toute proposition et nous vous aiderons à enrichir et à mettre en œuvre votre projet.</p>
                </div>
            </div>
        </div>
    </div>
